...
public class CustomerHandlersTests
{
    ...
    public async Task CreateCustomerCommandHandler_Should_CreateCustomer_Successfully()
    {
        ...
        mockUnitOfWork.Setup(u => u.CustomerRepository.InsertAsync(It.IsAny<CustomerManagementSystem.Domain.Entitys.Customer>()))
            .ReturnsAsync(true);
    ...
    public async Task UpdateCustomerCommandHandler_Should_UpdateCustomer_Successfully()
    {
        ...
        var newCustomer = new CustomerManagementSystem.Domain.Entitys.Customer
        {
            FirstName = "John",
            LastName = "Doe",
            DateOfBirth = new DateTime(1990, 1, 15),
        ...
        mockUnitOfWork.Setup(u => u.CustomerRepository.InsertAsync(It.IsAny<CustomerManagementSystem.Domain.Entitys.Customer>())).ReturnsAsync(true);
        ...
        mockUnitOfWork.Setup(u => u.CustomerRepository.UpdateAsync(It.IsAny<CustomerManagementSystem.Domain.Entitys.Customer>()))
            .ReturnsAsync(true);
    ...
    public async Task DeleteCustomerCommandHandler_Should_DeleteCustomer_Successfully()
    {
        ...
        var customerToDelete = new CustomerManagementSystem.Domain.Entitys.Customer
        {
            FirstName = "ToDelete",
            LastName = "Customer",
        ...
        mockUnitOfWork.Setup(u => u.CustomerRepository.DeleteAsync(It.IsAny<CustomerManagementSystem.Domain.Entitys.Customer>()))
            .ReturnsAsync(true);
    ...
    public async Task GetCustomerByIdQueryHandler_Should_ReturnCustomerById_Successfully()
    {
        ...
        var customerToRetrieve = new CustomerManagementSystem.Domain.Entitys.Customer
        {
            FirstName = "John",
            LastName = "Doe",
            DateOfBirth = new DateTime(1990, 1, 15),
    ...
    public async Task GetAllCustomersQueryHandler_Should_ReturnListOfCustomerDtos_Successfully()
    {
        ...
        var customersToReturn = new List<CustomerManagementSystem.Domain.Entitys.Customer>
        {
            new CustomerManagementSystem.Domain.Entitys.Customer
            {
                FirstName = "John",
                LastName = "Doe",
                DateOfBirth = new DateTime(1990, 1, 15),
